...
$supplies = $controller->getSuministros($_SESSION['Bodega_id']);
            ...
            <table>
                ...
                <tbody>
                    ...
                    foreach ($supplies as $supply) {
                        echo "<tr>
                                <td>{$supply['id_inventario']}</td>
                                <td><input type='text' value='{$supply['producto']}' readonly></td>
                                <td><input type='text' value='{$supply['cantidaddisponible']}'></td>
                                <td><input type='text' value='{$supply['unidadmedida']}'></td>
                                <td><input type='text' value='{$supply['cantidadminima']}'></td>
                                <td><input type='text' value='{$supply['cantidadmaxima']}'></td>
                                <td><input type='text' value='{$supply['fechaultimaactualizacion']}'></td>
                              </tr>";
                    }
                    ?>
                </tbody>
